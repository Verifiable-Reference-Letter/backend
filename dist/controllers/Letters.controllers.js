...
router.post("/:letterId/contents/update", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (numRecipients === 0) {
        const success = yield letterContentsDbService.updateLetterContentsByLetterIdAndWriterId(data.encryptedFile, currentDate, req.params.letterId, req.body["auth"].publicAddress);
        console.log(success);
        if (!success) {
            res.status(400);
            res.json({ data: {} });
