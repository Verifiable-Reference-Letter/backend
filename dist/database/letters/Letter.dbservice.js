...
class LetterDbService extends dbservice_1.DatabaseService {
    constructor() {
        ...
        this.selectLetterByIdQuery = {
            text: "select letter_id, letter_requestor, U.name as letter_requestor_name, letter_writer, name as letter_writer_name, L.requested_at, L.uploaded_at from " +
                letterTableName +
                " where letter_id = $1;"
        };
    }
    selectLetterById(letterId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const letters = yield _super.runParameterizedQueryWithValuesArray.call(this, queryText, values);
            return letters[0];
        });
    }
    /**
